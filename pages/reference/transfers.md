...
See the [Two-phase transfer](../design/two-phase-transfer.md) guide
...
As an example, you might generate a [random id](../design/data-modeling.md#random-identifer) to
...
As an example, you might use a [random id](../design/data-modeling.md#random-identifer) that ties
